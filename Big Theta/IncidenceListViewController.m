...
@implementation IncidenceListViewController
...
- (void)viewDidLoad {
    ...
    addVertexImage.image = [UIImage imageNamed:@"O_V_E.jpg"];
    
    addEdgeImage.image = [UIImage imageNamed:@"O_1.jpg"];
    
    queryImage.image = [UIImage imageNamed:@"O_1.jpg"];
    
    removeVertexImage.image = [UIImage imageNamed:@"O_E.jpg"];
    
    removeEdgeImage.image = [UIImage imageNamed:@"O_E.jpg"];
    
    spaceImage.image = [UIImage imageNamed:@"O_E.jpg"];
}
